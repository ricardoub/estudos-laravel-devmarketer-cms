  ...
  <div class="slug-widget">
    ...
    <div class="button-wrapper wrapper">
      ...
      <b-dropdown hoverable v-show="!isEditing && slug.length > 1">
        <button class="save-slug-button button is-small" slot="trigger" @click.prevent="">
          <span>Actions</span>
  ...
  export default {
    ...
    methods: {
      ...
      editSlug: function() {
        ...
        this.isEditing = true;
        window.setTimeout(function () {document.getElementById('slug-editor').focus()}, 0); // must set timeout to wait for the thread
      },
      saveSlug: function() {
